...
const schools: SchoolData[] = [
  ...
  },
  {
    ...
    places: 490,
    scholarships: 8,
    duration: "7 years total (3+4)",
    program: "Doctor of Medicine (MD Provisional Entry)",
    code: "2260",
    model: "Mixed (Provisional + Grad)",
    competitiveness: "High",
    intakeSummary: "Very Large (~400–490 total pipeline)",
    campus: "Herston (Brisbane), St Lucia",
    ...
    stations: "8",
    stationTime: "Varies",
    interviewAreas: ["Communication", "Ethics", "Reflection", "Suitability", "Teamwork"],
    overviewNote: "UQ combines a large-scale MD ecosystem with provisional-entry pathways that students often misunderstand without a clear map.",
    entryProcess: "QTAC and UQ-specific provisional/graduate structures need to be separated carefully.",
    ruralInfo: "Queensland's distributed training network is one of UQ's strongest structural advantages.",
    ruralEligibility: ["Rural threshold differences can be meaningful", "Distributed Queensland placements are a strategic plus", "Provisional vs graduate route matters"],
    biomedPathway: true,
    compareInsights: ["Huge total pipeline but not a simple single-lane program", "Queensland footprint is broad", "Users must distinguish provisional from graduate entry"],
  },
  {
    id: "uwa",
